...
export default function AuthWrapper({ title, description, children }: AuthWrapperProps) {
  return (
    <div className="relative overflow-hidden bg-auth-scene-gradient bg-[length:300%_300%] animate-gradient-shift flex min-h-dvh w-full items-center justify-center p-6 md:p-10">
