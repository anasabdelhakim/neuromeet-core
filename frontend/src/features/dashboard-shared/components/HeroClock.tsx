...
export function HeroClock({ showUpcoming = true }: HeroClockProps) {
  return (
        ...
        {showUpcoming && (
          <>
            <Badge className="max-sm:hidden backdrop-blur-xl border border-white-soft-muted bg-upcoming-badge p-4">
              Upcoming: <span className="text-primary-light mx-1">11:00 AM</span> —
              <span className="ml-1">System Design Lecture</span>
            </Badge>
            <Badge className="sm:hidden backdrop-blur-xl border border-white-soft-muted bg-upcoming-badge p-4">
              Upcoming: <span className="text-primary-light ml-1">11:00 AM</span>
            </Badge>
            <Badge className="sm:hidden backdrop-blur-xl border border-white-soft-muted bg-upcoming-badge p-4">
