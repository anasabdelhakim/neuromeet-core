...
import { adminNavItems } from "../constants/nav-items";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
            ...
            <TooltipTrigger
              render={
                <Link
                  href={href}
                  prefetch={true}
                  className={`flex flex-col md:flex-row items-center justify-center md:justify-start gap-1 md:gap-3 px-0 md:px-3 py-0.5 md:py-2.5 rounded-soft text-[12px] sm:text-xs md:text-base transition-all duration-fast ease-standard flex-1 md:flex-none ${
                    active
