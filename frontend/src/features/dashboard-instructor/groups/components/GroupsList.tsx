...
export async function GroupsList() {
  const groupsResult = await getGroupsAction();
      ...
      {groups.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {groups.map((group, idx) => {
            ...
            return (
              <Card key={group.id} className="bg-card-gradient border flex flex-col h-full hover:shadow-soft transition-all duration-normal ease-standard relative overflow-hidden group">
                ...
                <CardContent className="flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 border-t flex flex-row items-center justify-between mt-auto relative z-10">
