...
export default function ClarityConnectPage() {
  return (
    <div className="text-foreground flex flex-col relative  lg:overflow-hidden lg:h-screen antialiased">
      ...
      />
      <header className="w-full max-w-8xl mx-auto py-4 px-6 md:px-12 lg:px-24 flex items-center justify-between sticky top-0 z-50 max-sm:border-b max-sm:bg-background-header-sm">
        <Logo />
        <Avtar />
      </header>
