...
export function LoginForm() {
  ...
  const handleFillCredentials = (role: "student" | "instructor") => {
    if (role === "student") {
      ...
      setValue("password", "NuMeet#Inst@26", { shouldValidate: true, shouldDirty: true, shouldTouch: true });
    }
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between p-3 bg-background/50 rounded-lg border border-border gap-3">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        ...
                        <br />
                        Pass: <code className="bg-muted px-1 py-0.5 rounded font-mono text-primary font-semibold">NuMeet#Inst@26</code>
                      </p>
                    </div>
                    <Button
                      type="button"
